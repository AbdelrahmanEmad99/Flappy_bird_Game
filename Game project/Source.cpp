...
//the dimensions of the flappy and the pipes
float  fy  ;
...
void load_textures() {
	...
	textures.team.loadFromFile("blueG.png");

	textures.wall.loadFromFile("images (6).jpg");
	textures.but.loadFromFile("flappyBirdPlayButton.png");
}
...
void Flappy() {
	...
	//changing the color of the bird
	if (x == 1) {
...
void difficulty_level() {
	...
	Texture diff;
	diff.loadFromFile("Screenshot_20220408_160236.jpg");
...
void makers() {
	...
	game.made_by.setFillColor(Color::Cyan);
	//game.made_by.setFillColor(Color::Red);
	game.made_by.setOutlineThickness(3);

	//game.made_by.setFillColor(Color(190,140,130,155));
	game.made_by.setStyle(sf::Text::Bold );

	game.made_by.setCharacterSize(35);
